...
const searchBox = document.querySelector("#search-box"), countryList = document.querySelector(".country-list"), countryInfo = document.querySelector(".country-info");
const clearContent = ()=>{
...
const searchCountry = (event)=>{
    ...
    (0, _fetchCountries.fetchCountries)(findCountry).then((country)=>{
...
const renderCountryInfo = (country)=>{
    const markup = country.map(({ name , capital , population , flags , languages  })=>{
        return `<section><h1><img src="${flags.svg}" alt="${name.official}" width="100" height="60">&nbsp ${name.official}</h1>
...
searchBox.addEventListener("input", (0, _lodashDebounceDefault.default)(searchCountry, DEBOUNCE_DELAY));

},{"./css/styles.css":"1CY4s","./fetchCountries":"fTQqv","notiflix":"5WWYd","lodash.debounce":"3JP5n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"fTQqv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
